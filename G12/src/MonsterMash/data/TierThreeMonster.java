 ...
 * @author $Author sis13 $
 */
public class TierThreeMonster implements Monster {
     ...
     * @see Player
     */
    public TierThreeMonster(String id, String name, String userID){
        this.id = id;
        this.name = name;
        this.userID = userID;
    }
     ...
     * @param userID 
     */
    public TierThreeMonster(String name, String userID){
        this.id = "0";
	    this.name = name;
	    this.dob = new Date();
    ...
    public TierThreeMonster(String id, String name, Date dob, Date dod, Double baseStrength, Double currentStrength, Double baseDefence, Double currentDefence, Double baseHealth, Double currentHealth, float fertility, String userID, int saleOffer, int breedOffer) {
        this.id = id;
        this.name = name;
        this.dob = dob;
        this.dod = dod;
