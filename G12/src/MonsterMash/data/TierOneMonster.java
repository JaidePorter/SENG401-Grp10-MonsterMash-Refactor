...
public class TierOneMonster implements Monster {
    ...
    public TierOneMonster(String name, String userID){
        ...
        this.baseStrength = (double)(200 + r.nextDouble() * (300 - 200));
        this.currentStrength = (double)(200 + r.nextDouble() * (300 - 200));
        this.baseDefence = (double)(200 + r.nextDouble() * (300 - 200));
        this.currentDefence = (double)(200 + r.nextDouble() * (300 - 200));
        this.baseHealth = (double)(2000 + r.nextDouble() * (3000 - 2000));
        this.currentHealth = (double)(2000 + r.nextDouble() * (this.baseHealth - 2000));
	    this.fertility = (float)(0.6 + r.nextFloat() * (1.0 - 0.6));
        this.userID = userID;
        this.saleOffer = 0;
        this.breedOffer = 0;
    }
